...
class Genius_Model_FiltreDouchetteRing
{

    public static function getTerminaux() {
        global $db;
        $sql = " SELECT * FROM ec_filtres_ring";
    ...
    public static function findArt($id) {
        ...
        $sql = $db
            ->select()
            ->from('ec_filtres_ring')
            ->where("ec_filtres_ring.product_id = $id")
        ;
        return $sql;
    }
    ...
    public function select($id = null){
        ...
        $sql = $db
            ->select()
            ->from('ec_filtres_ring')
            ->join('ec_products_multilingual', 'ec_filtres_ring.product_m_id = ec_products_multilingual.id',
                [
