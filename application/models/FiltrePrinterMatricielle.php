 ...
 * Time: 10:51
 */
class Genius_Model_FiltrePrinterMatricielle
{

    public static function getAll() {
        global $db;
        $sql = " SELECT * FROM ec_filtre_matricielles  ";
    ...
    public static function findArt($id) {
        ...
        $sql = $db
            ->select()
            ->from('ec_filtre_matricielles')
            ->where("ec_filtre_matricielles.product_id = $id")
        ;
        return $sql;
    }
    ...
    public function select(){
        ...
        $sql = $db
            ->select()
            ->from('ec_filtre_matricielles')
            ->join('ec_products_multilingual', 'ec_filtre_matricielles.product_m_id = ec_products_multilingual.id',
                [
