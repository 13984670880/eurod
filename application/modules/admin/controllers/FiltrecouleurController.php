...
class Admin_FiltrecouleurController extends Genius_AbstractController
{
    ...
    public function indexAction()
    {
        ...
        $this->getResponse()->setRedirect($baseUrl->baseUrl().'/admin/filtrecouleur/all');
    }
    ...
    public function allAction()
    {
        ...
        $printers = Genius_Model_FiltreEtiquetteCouleur::all();
    ...
    public function postAction()
    {
        ...
        $where['ec_filtre_couleurs.id = ?'] = $id;

        $result = $db->update('ec_filtre_couleurs',$_POST,$where);

        $baseUrl = new Zend_View_Helper_BaseUrl();
        $url = '/admin/filtrecouleur/all/page/'.$page;
    ...
    public function editAction()
    {
        ...
        $request = Genius_Model_FiltreEtiquetteCouleur::find($id);
    ...
    public function updateAction()
    {
        ...
        $result = $db->update('ec_filtre_couleurs',$data,$where);
