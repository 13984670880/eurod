...
class Admin_FiltrepcController extends Genius_AbstractController
{
    ...
    public function indexAction()
    {
        ...
        $this->getResponse()->setRedirect($baseUrl->baseUrl().'/admin/filtrepc/all');
    }
    ...
    public function allAction()
    {
        ...
        $printers = Genius_Model_FiltrePostePc::all();
        $paginate_ = 10;
    ...
    public function postAction()
    {
        ...
        $result = $db->update('ec_filtres_pc',$_POST,$where);

        $baseUrl = new Zend_View_Helper_BaseUrl();
        $url = '/admin/filtrepc/all/page/'.$page;
    ...
    public function editAction()
    {
        ...
        $request = Genius_Model_FiltrePostePc::find($id);
    ...
    public function updateAction()
    {
        ...
        $result = $db->update('ec_filtres_pc',$data,$where);
