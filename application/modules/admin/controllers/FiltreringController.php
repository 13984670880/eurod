...
class Admin_FiltreringController extends Genius_AbstractController
{
    ...
    public function indexAction()
    {
        ...
        $this->getResponse()->setRedirect($baseUrl->baseUrl().'/admin/filtrering/all');
    }
    ...
    public function allAction()
    {
        ...
        $printers = Genius_Model_FiltreDouchetteRing::all();
    ...
    public function postAction()
    {
        ...
        $where['ec_filtres_ring.id = ?'] = $id;

        $result = $db->update('ec_filtres_ring',$_POST,$where);

        $baseUrl = new Zend_View_Helper_BaseUrl();
        $url = '/admin/filtrering/all/page/'.$page;
    ...
    public function editAction()
    {
        ...
        $request = Genius_Model_FiltreDouchetteRing::find($id);
    ...
    public function updateAction()
    {
        ...
        $result = $db->update('ec_filtres_ring',$data,$where);
