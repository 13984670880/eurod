...
class Admin_FiltrematricielleController extends Genius_AbstractController
{
    ...
    public function allAction()
    {
        ...
        $douchettes = Genius_Model_FiltrePrinterMatricielle::all();
    ...
    public function postAction()
    {
        ...
        $where['ec_filtre_matricielles.id = ?'] = $id;

        $result = $db->update('ec_filtre_matricielles',$_POST,$where);

        $baseUrl = new Zend_View_Helper_BaseUrl();
        $url = '/admin/filtrematricielle/all/page/'.$page;
    ...
    public function editAction()
    {
        ...
        $request = Genius_Model_FiltrePrinterMatricielle::find($id);
    ...
    public function updateAction()
    {
        ...
        $result = $db->update('ec_filtre_matricielles',$data,$where);
