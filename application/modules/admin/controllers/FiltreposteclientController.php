...
class Admin_FiltreposteclientController extends Genius_AbstractController
{
    ...
    public function indexAction()
    {
        ...
        $this->getResponse()->setRedirect($baseUrl->baseUrl().'/admin/filtreposteclient/all');
    }
    ...
    public function allAction()
    {
        ...
        $printers = Genius_Model_FiltrePosteClient::all();
        $paginate_ = 10;
    ...
    public function postAction()
    {
        ...
        $where['ec_filtres_client.id = ?'] = $id;

        $result = $db->update('ec_filtres_client',$_POST,$where);

        $baseUrl = new Zend_View_Helper_BaseUrl();
        $url = '/admin/filtreposteclient/all/page/'.$page;
    ...
    public function editAction()
    {
        ...
        $request = Genius_Model_FiltrePosteClient::find($id);
    ...
    public function updateAction()
    {
        ...
        $result = $db->update('ec_filtres_client',$data,$where);
