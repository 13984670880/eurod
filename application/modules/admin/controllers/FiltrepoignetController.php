...
class Admin_FiltrepoignetController extends Genius_AbstractController
{
    ...
    public function indexAction()
    {
        ...
        $this->getResponse()->setRedirect($baseUrl->baseUrl().'/admin/filtrepoignet/all');
    }
    ...
    public function allAction()
    {
        ...
        $terminal = Genius_Model_FiltreTerminalPoignet::all();
        $paginate_ = 10;
    ...
    public function postAction()
    {
        ...
        $result = $db->update('ec_filtres_poignet',$_POST,$where);

        $baseUrl = new Zend_View_Helper_BaseUrl();
        $url = '/admin/filtrepoignet/all/page/'.$page;
    ...
    public function editAction()
    {
        ...
        $request = Genius_Model_FiltreTerminalPoignet::find($id);
    ...
    public function updateAction()
    {
        ...
        $result = $db->update('ec_filtres_poignet',$data,$where);
